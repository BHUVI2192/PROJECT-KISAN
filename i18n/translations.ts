...
export const translations: Record<string, any> = {
  en: {
    ...
    chat: {
      ...
      status: "Online • Powered by Gemini",
  ...
  hi: {
    app: {
      ...
      powered_by: "जेमिनी 2.5 द्वारा संचालित",
    ...
    chat: {
      ...
      status: "ऑनलाइन • जेमिनी द्वारा संचालित",
  ...
  pa: {
    app: { title: "ਕਿਸਾਨ AI", skip_link: "ਮੁੱਖ ਸਮੱਗਰੀ 'ਤੇ ਜਾਓ", powered_by: "ਜੇਮਿਨੀ 2.5 ਦੁਆਰਾ ਸੰਚਾਲਿਤ", menu_open: "ਮੇਨੂ ਖੋਲ੍ਹੋ", menu_close: "ਮੇਨੂ ਬੰਦ ਕਰੋ" },
    ...
    chat: { title: "ਮਾਹਰ ਐਗਰੀ-ਚੈਟ", status: "ਆਨਲਾਈਨ • ਜੇਮਿਨੀ ਦੁਆਰਾ ਸੰਚਾਲਿਤ", welcome_msg: "ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ! ਮੈਂ ਤੁਹਾਡਾ ਕਿਸਾਨ AI ਸਹਾਇਕ ਹਾਂ। ਖੇਤੀ, ਫਸਲਾਂ, ਕੀਮਤਾਂ ਜਾਂ ਮੌਸਮ ਬਾਰੇ ਮੇਰੇ ਤੋਂ ਕੁਝ ਵੀ ਪੁੱਛੋ!", input_placeholder: "ਆਪਣਾ ਸਵਾਲ ਇੱਥੇ ਲਿਖੋ...", send_label: "ਸੁਨੇਹਾ ਭੇਜੋ", typing: "ਬੋਟ ਲਿਖ ਰਿਹਾ ਹੈ" },
  ...
  mr: {
    app: { title: "किसान AI", skip_link: "मुख्य सामग्रीकडे जा", powered_by: "जेमिनी 2.5 द्वारे समर्थित", menu_open: "मेनू उघडा", menu_close: "मेनू बंद करा" },
    ...
    chat: { title: "तज्ञ एग्री-चॅट", status: "ऑनलाइन • जेमिनी द्वारे समर्थित", welcome_msg: "नमस्ते! मी तुमचा किसान AI सहाय्यक आहे. शेती, पिके, किंमती किंवा हवामानाबद्दल मला काहीही विचारा!", input_placeholder: "अपना प्रश्न येथे टाइप करा...", send_label: "संदेश पाठवा", typing: "बॉट टाइप करत आहे" },
  ...
  kn: {
    app: { title: "ಕಿಸಾನ್ AI", skip_link: "ಮುಖ್ಯ ವಿಷಯಕ್ಕೆ ತೆರಳಿ", powered_by: "ಜೆಮಿನಿ 2.5 ರ ಮೂಲಕ", menu_open: "ಮೆನು ತೆರೆಯಿರಿ", menu_close: "ಮೆನು ಮುಚ್ಚಿ" },
    ...
    chat: { title: "ತಜ್ಞ ಎಗ್ರಿ-ಚಾಟ್", status: "ಆನ್‌ಲೈನ್ • ಜೆಮಿನಿ ಇಂದ ನಡೆಸಲ್ಪಡುತ್ತಿದೆ", welcome_msg: "ನಮಸ್ಕಾರ! ನಾನು ನಿಮ್ಮ ಕಿಸಾನ್ AI ಸಹಾಯಕ. ಕೃಷಿ, ಬೆಳೆಗಳು, ಬೆಲೆಗಳು ಅಥವಾ ಹವಾಮಾನದ ಬಗ್ಗೆ ನನ್ನನ್ನು ಏನೇ ಕೇಳಿ!", input_placeholder: "ನಿಮ್ಮ ಪ್ರಶ್ನೆಯನ್ನು ಇಲ್ಲಿ ಟೈಪ್ ಮಾಡಿ...", send_label: "ಸಂದೇಶ ಕಳುಹಿಸಿ", typing: "ಬಾಟ್ ಟೈಪ್ ಮಾಡುತ್ತಿದೆ" },
